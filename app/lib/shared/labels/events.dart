...
/// Event-domain Vietnamese labels for the bakery app.
///
/// Per the VN Label Policy in CLAUDE.md and §5 of
/// docs/flutter-coding-standards.md, new user-facing copy for the events
...
/// `EventsLabels.*` for new labels or `VN.*` for legacy labels re-exported
/// above.
class EventsLabels {
  EventsLabels._();
