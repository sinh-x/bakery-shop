      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '${VN.expenseLoggedByLabel}: ${event.loggedBy.isNotEmpty ? (event.staffName.isNotEmpty ? event.staffName : event.loggedBy) : '—'} • ${VN.expensePaidByNameLabel}: ${data.paidByName.isNotEmpty ? data.paidByName : '—'}',
            ),
