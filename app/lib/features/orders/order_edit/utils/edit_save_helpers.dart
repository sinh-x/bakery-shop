...
Future<({Customer? customer, bool touched})> maybeAutoCreateCustomer({
  ...
  if (customerId != null) {
    return (customer: selectedCustomer, touched: false);
  }
  ...
  try {
    ...
    return (customer: result.customer, touched: true);
  } catch (e) {
