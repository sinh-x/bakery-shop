...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,orderRef,publicOrderCode,customerName,customerPhone,deliveryPhone,customerId,const DeepCollectionEquality().hash(items),totalPrice,status,dueDate,dueTime,deliveryType,deliveryAddress,shippingFee,notes,source,createdBy,amountPaid,isPaid,const DeepCollectionEquality().hash(packingChecklist),workTicketPrintedAt,workTicketPrintedBy,createdStaffName,workTicketPrintedStaffName,urgency,acknowledgedAt,const DeepCollectionEquality().hash(missingFields),completeness,latitude,longitude,googleMapsUrl,deliveryTimeSlot,assignedStaffId,assignedStaffName,createdAt,updatedAt]);

@override
String toString() {
  return 'Order(id: $id, orderRef: $orderRef, publicOrderCode: $publicOrderCode, customerName: $customerName, customerPhone: $customerPhone, deliveryPhone: $deliveryPhone, customerId: $customerId, items: $items, totalPrice: $totalPrice, status: $status, dueDate: $dueDate, dueTime: $dueTime, deliveryType: $deliveryType, deliveryAddress: $deliveryAddress, shippingFee: $shippingFee, notes: $notes, source: $source, createdBy: $createdBy, amountPaid: $amountPaid, isPaid: $isPaid, packingChecklist: $packingChecklist, workTicketPrintedAt: $workTicketPrintedAt, workTicketPrintedBy: $workTicketPrintedBy, createdStaffName: $createdStaffName, workTicketPrintedStaffName: $workTicketPrintedStaffName, urgency: $urgency, acknowledgedAt: $acknowledgedAt, missingFields: $missingFields, completeness: $completeness, latitude: $latitude, longitude: $longitude, googleMapsUrl: $googleMapsUrl, deliveryTimeSlot: $deliveryTimeSlot, assignedStaffId: $assignedStaffId, assignedStaffName: $assignedStaffName, createdAt: $createdAt, updatedAt: $updatedAt)';
}
