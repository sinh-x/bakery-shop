...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderRef,customerName,customerPhone,const DeepCollectionEquality().hash(items),totalPrice,status,dueDate,dueTime,deliveryType,deliveryAddress,notes,isPaid,const DeepCollectionEquality().hash(packingChecklist),createdAt,updatedAt);

@override
String toString() {
  return 'Order(id: $id, orderRef: $orderRef, customerName: $customerName, customerPhone: $customerPhone, items: $items, totalPrice: $totalPrice, status: $status, dueDate: $dueDate, dueTime: $dueTime, deliveryType: $deliveryType, deliveryAddress: $deliveryAddress, notes: $notes, isPaid: $isPaid, packingChecklist: $packingChecklist, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String orderRef, String customerName, String customerPhone, List<OrderItem> items, double totalPrice, String status, String? dueDate, String? dueTime, String deliveryType, String deliveryAddress, String notes, bool isPaid, List<PackingItem> packingChecklist, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of Order
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderRef = null,Object? customerName = null,Object? customerPhone = null,Object? items = null,Object? totalPrice = null,Object? status = null,Object? dueDate = freezed,Object? dueTime = freezed,Object? deliveryType = null,Object? deliveryAddress = null,Object? notes = null,Object? isPaid = null,Object? packingChecklist = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String orderRef,  String customerName,  String customerPhone,  List<OrderItem> items,  double totalPrice,  String status,  String? dueDate,  String? dueTime,  String deliveryType,  String deliveryAddress,  String notes,  bool isPaid,  List<PackingItem> packingChecklist,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Order() when $default != null:
return $default(_that.id,_that.orderRef,_that.customerName,_that.customerPhone,_that.items,_that.totalPrice,_that.status,_that.dueDate,_that.dueTime,_that.deliveryType,_that.deliveryAddress,_that.notes,_that.isPaid,_that.packingChecklist,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
switch (_that) {
case _Order():
return $default(_that.id,_that.orderRef,_that.customerName,_that.customerPhone,_that.items,_that.totalPrice,_that.status,_that.dueDate,_that.dueTime,_that.deliveryType,_that.deliveryAddress,_that.notes,_that.isPaid,_that.packingChecklist,_that.createdAt,_that.updatedAt);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderRef,customerName,customerPhone,const DeepCollectionEquality().hash(_items),totalPrice,status,dueDate,dueTime,deliveryType,deliveryAddress,notes,isPaid,const DeepCollectionEquality().hash(_packingChecklist),createdAt,updatedAt);
...
/// Create a copy of Order
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? orderRef = null,Object? customerName = null,Object? customerPhone = null,Object? items = null,Object? totalPrice = null,Object? status = null,Object? dueDate = freezed,Object? dueTime = freezed,Object? deliveryType = null,Object? deliveryAddress = null,Object? notes = null,Object? isPaid = null,Object? packingChecklist = null,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_Order(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,orderRef: null == orderRef ? _self.orderRef : orderRef // ignore: cast_nullable_to_non_nullable
as String,customerName: null == customerName ? _self.customerName : customerName // ignore: cast_nullable_to_non_nullable
