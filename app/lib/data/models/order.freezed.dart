...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,orderRef,publicOrderCode,customerName,customerPhone,deliveryPhone,customerId,const DeepCollectionEquality().hash(items),totalPrice,status,dueDate,dueTime,deliveryType,deliveryAddress,shippingFee,notes,source,createdBy,amountPaid,isPaid,const DeepCollectionEquality().hash(packingChecklist),workTicketPrintedAt,workTicketPrintedBy,urgency,acknowledgedAt,const DeepCollectionEquality().hash(missingFields),completeness,createdAt,updatedAt]);

@override
String toString() {
  return 'Order(id: $id, orderRef: $orderRef, publicOrderCode: $publicOrderCode, customerName: $customerName, customerPhone: $customerPhone, deliveryPhone: $deliveryPhone, customerId: $customerId, items: $items, totalPrice: $totalPrice, status: $status, dueDate: $dueDate, dueTime: $dueTime, deliveryType: $deliveryType, deliveryAddress: $deliveryAddress, shippingFee: $shippingFee, notes: $notes, source: $source, createdBy: $createdBy, amountPaid: $amountPaid, isPaid: $isPaid, packingChecklist: $packingChecklist, workTicketPrintedAt: $workTicketPrintedAt, workTicketPrintedBy: $workTicketPrintedBy, urgency: $urgency, acknowledgedAt: $acknowledgedAt, missingFields: $missingFields, completeness: $completeness, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
switch (_that) {
case _Order():
return $default(_that.id,_that.orderRef,_that.publicOrderCode,_that.customerName,_that.customerPhone,_that.deliveryPhone,_that.customerId,_that.items,_that.totalPrice,_that.status,_that.dueDate,_that.dueTime,_that.deliveryType,_that.deliveryAddress,_that.shippingFee,_that.notes,_that.source,_that.createdBy,_that.amountPaid,_that.isPaid,_that.packingChecklist,_that.workTicketPrintedAt,_that.workTicketPrintedBy,_that.urgency,_that.acknowledgedAt,_that.missingFields,_that.completeness,_that.createdAt,_that.updatedAt);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,orderRef,publicOrderCode,customerName,customerPhone,deliveryPhone,customerId,const DeepCollectionEquality().hash(_items),totalPrice,status,dueDate,dueTime,deliveryType,deliveryAddress,shippingFee,notes,source,createdBy,amountPaid,isPaid,const DeepCollectionEquality().hash(_packingChecklist),workTicketPrintedAt,workTicketPrintedBy,urgency,acknowledgedAt,const DeepCollectionEquality().hash(_missingFields),completeness,createdAt,updatedAt]);
