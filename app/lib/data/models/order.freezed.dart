...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,orderRef,publicOrderCode,customerName,customerPhone,deliveryPhone,customerId,const DeepCollectionEquality().hash(items),totalPrice,status,dueDate,dueTime,deliveryType,deliveryAddress,shippingFee,notes,source,createdBy,amountPaid,isPaid,const DeepCollectionEquality().hash(packingChecklist),workTicketPrintedAt,workTicketPrintedBy,createdAt,updatedAt]);

@override
String toString() {
  return 'Order(id: $id, orderRef: $orderRef, publicOrderCode: $publicOrderCode, customerName: $customerName, customerPhone: $customerPhone, deliveryPhone: $deliveryPhone, customerId: $customerId, items: $items, totalPrice: $totalPrice, status: $status, dueDate: $dueDate, dueTime: $dueTime, deliveryType: $deliveryType, deliveryAddress: $deliveryAddress, shippingFee: $shippingFee, notes: $notes, source: $source, createdBy: $createdBy, amountPaid: $amountPaid, isPaid: $isPaid, packingChecklist: $packingChecklist, workTicketPrintedAt: $workTicketPrintedAt, workTicketPrintedBy: $workTicketPrintedBy, createdAt: $createdAt, updatedAt: $updatedAt)';
}
