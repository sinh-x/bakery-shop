...
mixin _$BakeryEvent {
 ...
 int get id;@JsonKey(fromJson: parseApiDateTimeRequired, toJson: _timestampToJson) DateTime get timestamp; String get type; String get summary; List<String> get tags;@JsonKey(name: 'logged_by') String get loggedBy; String get source; Map<String, dynamic> get data;@JsonKey(name: 'order_id') int? get orderId;
...
@useResult
$Res call({
 int id,@JsonKey(fromJson: parseApiDateTimeRequired, toJson: _timestampToJson) DateTime timestamp, String type, String summary, List<String> tags,@JsonKey(name: 'logged_by') String loggedBy, String source, Map<String, dynamic> data,@JsonKey(name: 'order_id') int? orderId
});
...
@override@JsonKey(fromJson: parseApiDateTimeRequired, toJson: _timestampToJson) final  DateTime timestamp;
