...
mixin _$BakeryEvent {
 ...
 int get id;@JsonKey(fromJson: parseApiDateTime) DateTime get timestamp; String get type; String get summary; List<String> get tags;@JsonKey(name: 'logged_by') String get loggedBy; String get source; Map<String, dynamic> get data;@JsonKey(name: 'order_id') int? get orderId;
...
@useResult
$Res call({
 int id,@JsonKey(fromJson: parseApiDateTime) DateTime timestamp, String type, String summary, List<String> tags,@JsonKey(name: 'logged_by') String loggedBy, String source, Map<String, dynamic> data,@JsonKey(name: 'order_id') int? orderId
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(fromJson: parseApiDateTime)  DateTime timestamp,  String type,  String summary,  List<String> tags, @JsonKey(name: 'logged_by')  String loggedBy,  String source,  Map<String, dynamic> data, @JsonKey(name: 'order_id')  int? orderId)  $default,) {final _that = this;
switch (_that) {
case _BakeryEvent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(fromJson: parseApiDateTime)  DateTime timestamp,  String type,  String summary,  List<String> tags, @JsonKey(name: 'logged_by')  String loggedBy,  String source,  Map<String, dynamic> data, @JsonKey(name: 'order_id')  int? orderId)?  $default,) {final _that = this;
switch (_that) {
case _BakeryEvent() when $default != null:
return $default(_that.id,_that.timestamp,_that.type,_that.summary,_that.tags,_that.loggedBy,_that.source,_that.data,_that.orderId);case _:
  return null;
