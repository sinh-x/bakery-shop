...
mixin _$BakeryEvent {
 ...
 int get id; DateTime get timestamp; String get type; String get summary; List<String> get tags;@JsonKey(name: 'logged_by') String get loggedBy; String get source; Map<String, dynamic> get data; int? get orderId;
...
@useResult
$Res call({
 int id, DateTime timestamp, String type, String summary, List<String> tags,@JsonKey(name: 'logged_by') String loggedBy, String source, Map<String, dynamic> data, int? orderId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  DateTime timestamp,  String type,  String summary,  List<String> tags, @JsonKey(name: 'logged_by')  String loggedBy,  String source,  Map<String, dynamic> data,  int? orderId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BakeryEvent() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  DateTime timestamp,  String type,  String summary,  List<String> tags, @JsonKey(name: 'logged_by')  String loggedBy,  String source,  Map<String, dynamic> data,  int? orderId)  $default,) {final _that = this;
switch (_that) {
case _BakeryEvent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  DateTime timestamp,  String type,  String summary,  List<String> tags, @JsonKey(name: 'logged_by')  String loggedBy,  String source,  Map<String, dynamic> data,  int? orderId)?  $default,) {final _that = this;
switch (_that) {
case _BakeryEvent() when $default != null:
return $default(_that.id,_that.timestamp,_that.type,_that.summary,_that.tags,_that.loggedBy,_that.source,_that.data,_that.orderId);case _:
  return null;
...
class _BakeryEvent implements BakeryEvent {
  const _BakeryEvent({required this.id, required this.timestamp, this.type = 'note', required this.summary, final  List<String> tags = const <String>[], @JsonKey(name: 'logged_by') this.loggedBy = '', this.source = 'app', final  Map<String, dynamic> data = const <String, dynamic>{}, this.orderId}): _tags = tags,_data = data;
