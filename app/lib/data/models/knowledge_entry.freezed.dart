...
@override@JsonKey(name: 'created_at', fromJson: parseApiDateTimeRequired) final  DateTime createdAt;
@override@JsonKey(name: 'updated_at', fromJson: parseApiDateTimeRequired) final  DateTime updatedAt;
@override@JsonKey() final  bool pinned;
@override@JsonKey(name: 'pinned_at', fromJson: parseApiDateTime) final  DateTime? pinnedAt;
