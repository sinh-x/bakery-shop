...
mixin _$KnowledgeEntry {
 ...
 int get id; String get title; String get content; String get type; List<String> get tags;@JsonKey(name: 'logged_by') String get loggedBy; String get source;@JsonKey(name: 'created_at', fromJson: parseApiDateTime) DateTime get createdAt;@JsonKey(name: 'updated_at', fromJson: parseApiDateTime) DateTime get updatedAt; bool get pinned;@JsonKey(name: 'pinned_at', fromJson: _nullableTimestampFromJson) DateTime? get pinnedAt; List<KnowledgePhoto> get photos;
...
@useResult
$Res call({
 int id, String title, String content, String type, List<String> tags,@JsonKey(name: 'logged_by') String loggedBy, String source,@JsonKey(name: 'created_at', fromJson: parseApiDateTime) DateTime createdAt,@JsonKey(name: 'updated_at', fromJson: parseApiDateTime) DateTime updatedAt, bool pinned,@JsonKey(name: 'pinned_at', fromJson: _nullableTimestampFromJson) DateTime? pinnedAt, List<KnowledgePhoto> photos
});
...
class _KnowledgeEntry implements KnowledgeEntry {
  const _KnowledgeEntry({required this.id, required this.title, this.content = '', this.type = 'note', final  List<String> tags = const <String>[], @JsonKey(name: 'logged_by') this.loggedBy = '', this.source = 'app', @JsonKey(name: 'created_at', fromJson: parseApiDateTime) required this.createdAt, @JsonKey(name: 'updated_at', fromJson: parseApiDateTime) required this.updatedAt, this.pinned = false, @JsonKey(name: 'pinned_at', fromJson: _nullableTimestampFromJson) this.pinnedAt, final  List<KnowledgePhoto> photos = const <KnowledgePhoto>[]}): _tags = tags,_photos = photos;
...
@override@JsonKey(name: 'updated_at', fromJson: parseApiDateTime) final  DateTime updatedAt;
@override@JsonKey() final  bool pinned;
@override@JsonKey(name: 'pinned_at', fromJson: _nullableTimestampFromJson) final  DateTime? pinnedAt;
